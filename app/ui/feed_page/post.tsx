      ...
      <article className="post">
        ...
        <div className="post__content">
          <div className="post__medias">
            <img className="post__media" src="assets/insta-clone.png" alt="Post Content" />
            <img className="post__media" src="assets/insta-clone.png" alt="Post Content" />
          </div>
        </div>
          ...
          <div className="post__infos">
            ...
            <div className="post__description">
              <span>
                ...
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus voluptates expedita
                ab vel dolore voluptatem rerum repudiandae unde temporibus sed quos quis illo,
                dolores facere officiis autem. Error, non quidem.
              </span>
            </div>
